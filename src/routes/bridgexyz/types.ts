...
type Customer = {
  ...
  liquidation_addresses: { [key: string]: (LiquidationAddress | LiquidationAddressSepa ) },
}
...
type KYC_Status = "not_started" | "pending" | "incomplete" |  "awaiting_ubo" | "manual_review" | "under_review" | "approved" | "rejected";
type TOS_Status = "pending" | "approved";


export { PriceResponse, Customer, BankAccountCommon, BankAccountUS, BankAccountIBAN, KYC_Status, TOS_Status, LiquidationAddress, LiquidationAddressSepa };